...
SiMMLTrack::SiMMLTrack() {
	...
	_setting_envelope_exp.resize_initialized(2);
	_setting_envelope_voice.resize_initialized(2);
	_setting_envelope_note.resize_initialized(2);
	_setting_envelope_pitch.resize_initialized(2);
	_setting_envelope_filter.resize_initialized(2);

	_table_envelope_mod_amp.resize_initialized(2);
	_table_envelope_mod_pitch.resize_initialized(2);
}
