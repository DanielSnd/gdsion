...
SiOPMWavePCMTable::SiOPMWavePCMTable() :
	...
	_note_data_map.resize_initialized(SiOPMRefTable::NOTE_TABLE_SIZE);
	_note_volume_map.resize_initialized(SiOPMRefTable::NOTE_TABLE_SIZE);
	_note_pan_map.resize_initialized(SiOPMRefTable::NOTE_TABLE_SIZE);
